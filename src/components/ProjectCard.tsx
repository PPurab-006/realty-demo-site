  ...
  return (
    <Link href={`/projects/${project.slug}`}>
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex-shrink-0 w-[85vw] sm:w-[420px] md:w-[480px] h-[560px] md:h-[620px] relative group block cursor-pointer"
        style={{
          perspective: '1000px',
        }}
        data-hoverable
      >
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 z-10">
            <h3 className="font-display text-2xl md:text-3xl text-white font-bold mb-2 leading-tight group-hover:text-brand-gold transition-colors duration-300">
              {project.name}
            </h3>
